...
class SiteSettingsSeeder extends Seeder
{
    public function run()
    {
        ...
        $settings->site_name = config('app.name', 'Liberu Software');
        ...
        $settings->site_email = 'support@liberu.co.uk';
        ...
        $settings->linkedin_url = 'https://www.linkedin.com/showcase/liberu-software';
