...
return new class extends SettingsMigration
{
    public function up(): void
    {
        ...
        $this->migrator->add('site.facebook_url', 'https://www.facebook.com/liberusoftware');
        $this->migrator->add('site.twitter_url', 'https://x.com/liberusoftware');
        $this->migrator->add('site.github_url', 'https://www.github.com/liberusoftware');
        $this->migrator->add('site.youtube_url', 'https://www.youtube.com/@liberusoftware');
