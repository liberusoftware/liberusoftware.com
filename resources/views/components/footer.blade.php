    ...
    <div class="mx-auto max-w-screen-xl">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="flex mt-4 space-x-4 sm:space-x-6 sm:justify-center sm:mt-0">
                @if(app(\App\Settings\SiteSettings::class)->whatsapp_url)
                <a href="{{ app(\App\Settings\SiteSettings::class)->whatsapp_url }}"
                ...
                @endif
                @if(app(\App\Settings\SiteSettings::class)->youtube_url)
                <a href="{{ app(\App\Settings\SiteSettings::class)->youtube_url }}"
                    class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                @endif
                @if(app(\App\Settings\SiteSettings::class)->facebook_url)
                <a href="{{ app(\App\Settings\SiteSettings::class)->facebook_url }}"
                    class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path fill-rule="evenodd"
                ...
                @endif
                @if(app(\App\Settings\SiteSettings::class)->instagram_url)
                <a href="{{ app(\App\Settings\SiteSettings::class)->instagram_url }}"
                    class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                @endif
                @if(app(\App\Settings\SiteSettings::class)->twitter_url)
                <a href="{{ app(\App\Settings\SiteSettings::class)->twitter_url }}"
                    class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                @endif
                @if(app(\App\Settings\SiteSettings::class)->linkedin_url)
                <a href="{{ app(\App\Settings\SiteSettings::class)->linkedin_url }}"
                    class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                @endif
                @if(app(\App\Settings\SiteSettings::class)->github_url)
                <a href="{{ app(\App\Settings\SiteSettings::class)->github_url }}"
                    class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path fill-rule="evenodd"
